...
namespace AllPaintsEcomAPI.Helpers
{
    public static class AesEncryption
    {
        private static readonly byte[] Key = Encoding.UTF8.GetBytes("SheenlacMISPORTAL2025!$123456789"); // 16 bytes key
    ...
    public static class AesEncryption1
    {
        ...
        public static string Decrypt(string base64CipherText)
        {
            using (Aes aes = Aes.Create())
            {
                ...
                return sr.ReadToEnd(); // this should return your original JSON string
            }
        }
    }
